			     ...
			     nx_value_t *args)
{
    ...
    if ( str != NULL )
    {
	retval->string = nx_string_create_owned_throw(str, -1);
	retval->defined = TRUE;
    }
    else
    {
			   ...
			   nx_value_t *args)
{
	...
	nx_string_append_throw(result, str, (int) (ptr - str));
	nx_string_append_throw(result, dstptr, dstlen);
	...
	nx_string_append_throw(result, str, -1);
    }
