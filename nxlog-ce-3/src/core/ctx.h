...
typedef struct nx_ctx_data_t nx_ctx_data_t;

struct nx_ctx_data_t
{
    char *key;
    void *data;
    nx_ctx_data_t *next;
...
typedef struct nx_ctx_t
{
    ...
    nx_ctx_data_t       *data;		///< nx ctx data

    boolean		escape_glob_patterns;   ///< global parameter for any use of apr_fnmatch() (APR_FNM_NOESCAPE usage)
} nx_ctx_t;
