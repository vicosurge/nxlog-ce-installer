...
static void im_ssl_accept(nx_module_t *module)
{
	...
	if ( rv == APR_SUCCESS )
	{
	    ...
	    ssl = nx_ssl_from_socket(&(imconf->ssl_ctx), sock, 0, NULL);
	    ASSERT(ssl != NULL);
...
static void im_ssl_config(nx_module_t *module)
{
	...
	else if ( strcasecmp(curr->directive, "certfile") == 0 )
	{
	    ...
	    imconf->ssl_ctx.certfile = nx_cfg_unquote_string(curr, module->pool);
	}
	else if ( strcasecmp(curr->directive, "certkeyfile") == 0 )
	{
	    ...
	    imconf->ssl_ctx.certkeyfile = nx_cfg_unquote_string(curr, module->pool);
	}
	...
	else if ( strcasecmp(curr->directive, "cafile") == 0 )
	{
	    ...
	    imconf->ssl_ctx.cafile = nx_cfg_unquote_string(curr, module->pool);
	}
	else if ( strcasecmp(curr->directive, "cadir") == 0 )
	{
	    ...
	    imconf->ssl_ctx.cadir = nx_cfg_unquote_string(curr, module->pool);
	}
	else if ( strcasecmp(curr->directive, "crlfile") == 0 )
	{
	    ...
	    imconf->ssl_ctx.crlfile = nx_cfg_unquote_string(curr, module->pool);
	}
	else if ( strcasecmp(curr->directive, "crldir") == 0 )
	{
	    ...
	    imconf->ssl_ctx.crldir = nx_cfg_unquote_string(curr, module->pool);
	}
