...
install_deps() {
    ...
    case "${DISTRO_NAME}" in
        ...
        alpine)
            ...
            ALPINE_DEPS="build-base gcc make g++ tar apr-dev openssl-dev pcre-dev libdbi-dev openssl expat-dev zlib-dev perl perl-dev flex bison autoconf automake libtool libc-dev linux-headers"
